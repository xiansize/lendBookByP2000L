...
public class NfcCommon {
     ...
     * (on external storage).
     */
    public static final String HOME_DIR = "/NFCTcTool";
    ...
    private static final String LOG_TAG = NfcCommon.class.getSimpleName();
        ...
        if (file.exists()) {
            ...
            .setPositiveButton(R.string.action_replace,
                ...
                public void onClick(DialogInterface dialog, int which) {
                    // Replace.
                    if (NfcCommon.saveFile(file, lines, false)) {
...
//                                Toast.LENGTH_LONG).show();
            ...
            .setNeutralButton(R.string.action_append,
                ...
                public void onClick(DialogInterface dialog, int which) {
                    // Append.
                    if (NfcCommon.saveFileAppend(file, lines, isDump)) {
//                        Toast.makeText(context, R.string.info_save_successful,
//                                Toast.LENGTH_LONG).show();
                        activity.onSaveSuccessful();
                    } else {
...
//                        Toast.LENGTH_LONG).show();
    ...
    public static SharedPreferences getPreferences() {
        ...
        return PreferenceManager.getDefaultSharedPreferences(NFCApplication.getmAppContext());
    }
        ...
        if (mNfcAdapter != null && mNfcAdapter.isEnabled()) {
            ...
            mNfcAdapter.enableForegroundDispatch(
                    targetActivity, pendingIntent, null, new String[][]{
                            new String[]{NfcA.class.getName()}, new String[]{NfcV.class.getName()}});
        }
    }
    ...
    public static int checkCardType(Intent intent, Context context){
        if (NfcAdapter.ACTION_TECH_DISCOVERED.equals(intent.getAction())) {
            Tag tag = intent.getParcelableExtra(NfcAdapter.EXTRA_TAG);
            tag = MCReader.patchTag(tag);
            if (tag.getTechList()[0].equals("android.nfc.tech.NfcV"))
                return 1;
            else if (tag.getTechList()[0].equals("android.nfc.tech.NfcA"))
                treatAsNewTag(intent,context);
                return 2;
...
//                    Toast.LENGTH_LONG).show();
    ...
    public static boolean isValueBlock(String hexString) {
        byte[] b = NfcCommon.hexStringToByteArray(hexString);
...
//                    Toast.LENGTH_SHORT).show();
    ...
    public static void setmAppContext(Context mAppContext) {
        NfcCommon.mAppContext = mAppContext;
    }
}
