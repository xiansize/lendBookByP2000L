...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, com.tc.nfc.app.view.CompatUtils.dp2px(getContext(), 0));
        ta.recycle();
...
//        });
        ...
        setOnClickListener(cbOnClickListener);
    }
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(com.tc.nfc.app.view.SmoothCheckBox.this, mChecked);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(com.tc.nfc.app.view.SmoothCheckBox checkBox, boolean isChecked);
    }
    ...
    /**
     * 新增方法，设置checkbox能否被点击。
     * @param flag
     */
    public void isWorkOnClickListener(Boolean flag){
        if (flag){
            setOnClickListener(cbOnClickListener);
        }
        else{
