...
public class UpdateAppUtil {
    ...
    /**
     * 获取服务器的版本号
     * @param NFCApplication
     * @param listener
     */
    public static void getServerVersion(NFCApplication NFCApplication,ActionCallbackListener<Integer> listener){
        NFCApplication.getCommonAction().getServerVersion(listener);
    }
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    Log.d("JSON",connection.getResponseCode()+"");
                    //不能获取服务器响应
