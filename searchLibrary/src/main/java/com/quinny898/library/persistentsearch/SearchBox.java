...
public class SearchBox extends RelativeLayout {
	...
	public void setMicOnclickListener(OnClickListener micOnclickListener){
		overflow.setOnClickListener(micOnclickListener);
	}
...
//		this.results.setVisibility(View.VISIBLE);
	...
	public void setSearchBtnEnable(Boolean flag){
		search_btn.setEnabled(flag);
		if (flag){
			search_btn.setTextColor(Color.parseColor("#605f5f"));
		}
		else{
			search_btn.setTextColor(Color.parseColor("#dcdcdc"));
		}
	}
