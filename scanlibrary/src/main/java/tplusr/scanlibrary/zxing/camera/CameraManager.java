...
package tplusr.scanlibrary.zxing.camera;
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
			MAX_FRAME_WIDTH =MAX_FRAME_HEIGHT=(int)(0.625* Constants.pwidth);
			
			Log.d("xx", MAX_FRAME_WIDTH+" "+MAX_FRAME_HEIGHT);
			
			int width = findDesiredDimensionInRange(screenResolution.x,
					MIN_FRAME_WIDTH,MAX_FRAME_WIDTH)*4/3;
			int height = findDesiredDimensionInRange(screenResolution.y,
